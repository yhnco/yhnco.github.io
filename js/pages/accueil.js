...
export default tpl({
    ...
    data() {
        return {
            ...
            projectDisplay: 'Vous trouverez, en cliquant sur le lien ci-dessous, un exemple d\'une petite application météo utilisant la technologie VueJs dans le but de faire appel à un REST API, traiter et afficher les données reçues.',
    ...
    methods: {
        translation() {
            if (this.lang == 'en') {
                ...
                this.projectDisplay = 'Vous trouverez en cliquant sur le lien ci-dessous un exemple d\'une petite application utilisant la technologie VueJs dans le but de faire appel à un REST API, traiter et afficher les données recues.'
